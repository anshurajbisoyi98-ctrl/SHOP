...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Image panel */}
      <div className="hidden xl:block w-[45%] relative overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1576502200916-3808e07386a5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2065&q=80"
          alt="Register visual"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-l from-[#0f0f10]/60 to-transparent" />
        <div className="absolute bottom-12 left-10 right-10">
          <p className="text-white text-2xl font-bold leading-snug">
            Join thousands of happy<br />shoppers today.
          </p>
        </div>
      </div>
